...
// Simple product validation for JSON-based products
exports.validateSimpleProduct = (req, res, next) => {
    ...
    // Validate image URL format (more flexible validation)
    const urlPattern = /^https?:\/\/.+/i;
    if (!urlPattern.test(req.body.imageUrl)) {
        return res.status(400).json({ 
            success: false, 
